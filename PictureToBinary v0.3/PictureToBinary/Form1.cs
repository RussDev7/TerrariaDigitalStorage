                ...
                foreach (string image in files)
                {
                    ...
                    for (int j = 0; j < img.Height; j++)
                    {
                        for (int i = 0; i < img.Width; i++)
                        {
                            ...
                            // Get Color
                            if (pixel.Name == "ffffffff" || pixel.Name == "fffefefe" || pixel.Name == "fffdfdfd" || pixel.Name == "ffe5e5e5" || pixel.Name == "fff2f2f2") // White
                            {
                                // White
                                PhotoData = PhotoData + "1";
                            }
                            else if (pixel.Name == "ff000000" || pixel.Name == "ff010101" || pixel.Name == "ff020202") // Black
                            {
                                // Black
